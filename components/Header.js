	...
	return (
		<nav className="w-full h-full p-2 relative z-[1000]">
			...
			<ul className="flex font-fjalla md:hidden sm:hidden xsm:hidden">
				...
				<li className="flex flex-grow"></li>
				<Link href='/about'><li className="nav-list mx-2 my-6 rounded-md uppercase opacity-70 text-slate-100 cursor-pointer font-normal tracking-widest text-sm flex items-center hover:opacity-100 hover:bg-[#32323a] transition duration-250"><span className="m-3 flex-1">About</span></li></Link>
				<Link href='/shop'><li className="nav-list mx-2 my-6 rounded-md uppercase opacity-70 text-slate-100 cursor-pointer font-normal tracking-widest text-sm flex items-center hover:opacity-100 hover:bg-[#32323a] transition duration-250"><span className="m-3 flex-1">shop</span></li></Link>
				<Link href='/roadmap'><li className="nav-list mx-2 my-6 rounded-md uppercase opacity-70 text-slate-100 cursor-pointer font-normal tracking-widest text-sm flex items-center hover:opacity-100 hover:bg-[#32323a] transition duration-250"><span className="m-3 flex-1">roadmap</span></li></Link>
				<Link href='/team'><li className="nav-list mx-2 my-6 rounded-md uppercase opacity-70 text-slate-100 cursor-pointer font-normal tracking-widest text-sm  flex items-center hover:opacity-100 hover:bg-[#32323a] transition duration-250"><span className="m-3 flex-1">Team</span></li></Link>
				<Link href='/mint'><li className="nav-list mx-2 my-6 rounded-md uppercase opacity-70 text-slate-100 cursor-pointer font-normal tracking-widest text-sm  flex items-center hover:opacity-100 hover:bg-[#32323a] transition duration-250"><span className="m-3 flex-1">Mint</span></li></Link>
			</ul>
		</nav>
	);
}